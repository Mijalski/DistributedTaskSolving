...
{
    public class AlgorithmCreateCommandService : CreateCommandService<Algorithm, long, AlgorithmDto, string>
    {
        ...
        public AlgorithmCreateCommandService(IRepository<Algorithm, long> repository,
