...
namespace DistributedTaskSolving.Application.Business.JobSystem.JobInstances.Hubs.Clients
{
    public class JobInstanceHubClient : IAsyncDisposable
    {
        ...
        public async Task StartWorkAsync(string jobTypeName, string algorithmName = null, string programmingLanguageName = null)
        {
            if (!_started)
            {
            ...
            await _hubConnection.SendAsync("StartWorkOnJobType", jobTypeName, algorithmName, programmingLanguageName);
        }
